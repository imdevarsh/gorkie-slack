...
- `env_check.txt` at `/home/user/output/env_check.txt` in sandbox: generated by the PI agent during a sandbox init task, contains OS/Python/Node version info. Not a permanent file — sandbox is paused/killed between sessions.
