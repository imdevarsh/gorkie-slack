...
- Add a input truncation or something into the tool input so it doesnt get a huge blob of responses (refer http://github.com/techwithanirudh/discord-ai-bot)