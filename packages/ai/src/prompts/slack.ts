...
- readConversationHistory: read Slack channel history or thread replies — the current conversation always works (even private/DM), other channels must be public. It accepts a raw Slack channel id like C123456, a Chat SDK channel id like slack:C123456, or a full thread id like slack:C123456:1781599802.270109.
