...
Files, installed packages, downloaded attachments, generated artifacts, and changes live in the sandbox. They are not visible to Slack unless you explicitly use a host tool to upload or post them back.
